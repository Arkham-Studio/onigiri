...
namespace Arkham.Onigiri.AudioModule
{
    public class AudioSourceController : MonoBehaviour
    {
        ...
        private void OnEnable() => audioClipToPlay?.onChange.AddListener(OnAudioClipChange);
        private void OnDisable() => audioClipToPlay?.onChange.RemoveListener(OnAudioClipChange);
        ...
        private void OnAudioClipChange()
        {
            ...
            if (timeDelay != null)
                myAudioSource.time = timeDelay.Value;
            myAudioSource.Play();
