...
{
    public class IfColorEvent : MonoBehaviour
    {
        [PropertyOrder(-2)] public ColorVariable toCompare;
        ...
        public void CompareWith(Color _v)
        {
        ...
        public class ComparePackFloat
        {
            ...
            [HorizontalGroup("params"), HideLabel] public ColorReference value;
