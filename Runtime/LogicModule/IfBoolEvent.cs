...
{
    public class IfBoolEvent : MonoBehaviour
    {
        [PropertyOrder(-2)] public BoolVariable toCompare;
        ...
        public void CompareWith(bool _v)
        {
        ...
        public class ComparePackFloat
        {
            ...
            [HorizontalGroup("params"), HideLabel] public bool value;
